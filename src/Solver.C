...
std::optional<double>
sauron::Solver::triangleSolver(sauron::Ray &ray, std::vector<sauron::Point>& edges) const {
...
std::optional<double>
sauron::Solver::quadSolver(sauron::Ray &ray, std::vector<sauron::Point> &edges ) const {
